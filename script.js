...
class Player {
  ...
  heal (player) {
    ...
    return `${player.name} heals for ${heal} hp`
...
let player1 = new Player('Dilip',100,10 )
let player2 =new Player('Ujjwal',100,10)
  ...
  if(e.key=='p' && p1.health>0 &&game.isOver==false)
     {
      p2.strike(p2,p1,p2.attackDmg)
         document.getElementById('p2attack').play()
              console.log(p2HealthDiv.innerText)
